    ...
    return <>
        <div className="relative mt-24 sm:mt-32 sm:py-16">
            ...
            <div className="mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8">
                <div className="relative overflow-hidden rounded-2xl bg-computas-primary px-6 py-10 shadow-xl sm:px-12 sm:py-20">
                    <div aria-hidden="true" className="absolute inset-0 -mt-72 sm:-mt-32 md:mt-0">
                        ...
                        >
                            <path
                                className="text-computas-secondary text-opacity-40"
                                fill="currentColor"
                    ...
                    <div className="relative">
                        ...
                        <div className="mt-8 w-full flex justify-center">
                            <div className='border-computas-white bg-computas-primary border-4 p-6 rounded-md'>
